...
VALUES 
('查看用户', 'VIEW_USER', '查看用户权限', 1, 1, NOW()),      -- 1表示菜单权限
('编辑用户', 'EDIT_USER', '编辑用户权限', 1, 2, NOW()),      -- 2表示按钮权限
('删除用户', 'DELETE_USER', '删除用户权限', 1, 2, NOW()),    -- 2表示按钮权限
('查看角色', 'VIEW_ROLE', '查看角色权限', 1, 1, NOW()),      -- 1表示菜单权限
('编辑角色', 'EDIT_ROLE', '编辑角色权限', 1, 2, NOW()),      -- 2表示按钮权限
('查看权限', 'VIEW_PERMISSION', '查看权限权限', 1, 1, NOW()); -- 1表示菜单权限
